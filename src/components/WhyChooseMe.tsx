...
export default function WhyChooseMe() {
  ...
  return (
    <section
      className=""
    >
        <div  className={`grid grid-cols-1 md:grid-cols-2  gap-10 max-w-7xl mx-auto my-16 px-4 ${
      ...
      <div className="space-y-8">
        {features.map((feature, index) => (
          ...
          >
            ...
            >
              <span className="text-xs font-mono text-orange-500 dark:text-orange-300">[#]</span>
